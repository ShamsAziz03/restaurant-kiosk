				...
				<div className="flex gap-10 w-[100%]">
					...
					<div className="flex flex-col gap-5">
						<div>
							<div className="flex justify-between items-start">
								...
								<p className="text-3xl font-bold text-green-900">
									$ {props.activeItem?.price}
								</p>
							</div>

							<div className="flex gap-2 items-center">
								<RatingComponent rating={props.activeItem?.rating ?? 0} />
								<span className="mt-1 font-bold text-lg">
									({props.activeItem?.rating})
								</span>
							</div>
						</div>
						...
						<div className="space-y-4">
							...
							<p className="text-slate-700">{props.activeItem?.details}</p>
						</div>
						...
						<div className="flex justify-center items-center text-black">
							...
							{!!props.activeItem && (
								<AddToCartButton
									categoryId={props.activeItem?.categoryId}
									description={props.activeItem?.description}
									details={props.activeItem?.details}
									id={props.activeItem?.id}
									image={props.activeItem?.image}
									key={props.activeItem?.id}
									price={props.activeItem?.price}
									rating={props.activeItem?.rating}
...
export default DetailsDialogSearch;
