"use client";
import "../globals.css";
import { ChefHat, LogOut, Pencil, ShoppingBag } from "lucide-react";
...
const navigation = [
	{ name: "Orders", href: "/kitchen-staff-features/orders", icon: ShoppingBag },
	{
		name: "Edit Profile",
		href: "/kitchen-staff-features/editProfile",
		icon: Pencil,
	},
];
